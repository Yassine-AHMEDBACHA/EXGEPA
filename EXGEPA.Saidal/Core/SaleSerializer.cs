namespace EXGEPA.Saidal.Core
{
    ...
    public class SaleSerializer : Serializer<OutputCertificate>
    {
        private readonly IRepositoryDataProvider repositoryDataProvider;

        public SaleSerializer(IRepositoryDataProvider repositoryDataProvider)
        {
        ...
        {
            return $"Vente {instance.Key} {instance.Date:dd/MM/yyyy} {instance.Tag};{instance.Key}";
        }
        ...
        {
                return this.parameterProvider.TryGet("InterfaceFileNamePatternForSale", "SalesDump");
        }
    }
}