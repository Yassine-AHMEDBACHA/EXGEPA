namespace EXGEPA.Saidal.Core
{
    ...
    public class DestructionSerializer : Serializer<OutputCertificate>
    {
        private readonly IRepositoryDataProvider repositoryDataProvider;

        public DestructionSerializer(IRepositoryDataProvider repositoryDataProvider)
        {
        ...
        {
            return $"Destrcution {instance.Key} {instance.Date:dd/MM/yyyy} {instance.Tag};{instance.Key}";
        }
        ...
        {
            return this.parameterProvider.TryGet("InterfaceFileNamePatternForDestruction", "DestructionDump");
        }
    }
}
