...
using CORESI.WPF;
using EXGEPA.Model;
using EXGEPA.Report.TransferOrder;

namespace EXGEPA.Report
{
    public class TransferOrderReportPreviwer : ReportProvider<Model.TransferOrder>
    {
        public override void PrintSheet()
        {
            ...
            var report = new TransferOrderSheet();
            report.SheetTitle.Text = "Liste des Transfert";
